...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../on_chip_with_keyboard_pio.sopcinfo
...
# Design Name 
# setting SOPC_NAME is on_chip_with_keyboard_pio
SOPC_NAME := on_chip_with_keyboard_pio
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1556243151
SOPC_SYSID_FLAG += --timestamp=1556243151
ELF_PATCH_FLAG  += --timestamp 1556243151
